...
def test_agent_calls_tools_in_correct_order():
    ...
    artifacts = __import__("pathlib").Path(__file__).parent.parent / "artifacts" / "anomaly_pipeline.joblib"
    ...
    assert tool_calls == ["query_sensor_tool", "check_anomaly_tool", "trigger_alert_tool"]
